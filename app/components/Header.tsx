...
export default function Header() {
  ...
  // OAuth Î¶¨Îã§?¥Î†â?????∏ÏÖò???¥Î? Ï°¥Ïû¨?òÎäî Í≤ΩÏö∞Î•??ÑÌïú Ï¥àÍ∏∞ ?∏ÏÖò ?ïÏù∏
  useEffect(() => {
  ...
  /* ?Ä?Ä MY ?úÎ°≠?§Ïö¥ (?∞Ïä§?¨ÌÉë¬∑Î™®Î∞î??Í≥µÏö©) ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */
  const MyDropdown = () => (
    <div style={{
      ...
      <div style={{
        ...
        {/* ?πÏÖò 1: ?ÑÎ°ú??/ Î™®Îç∏ / ?ÖÎ°ú??*/}
        <MyMenuLink href="/profile"   icon={<IconDropUser   active={pathname.startsWith("/profile")}   />} onClick={() => setMyOpen(false)} active={pathname.startsWith("/profile")}>???ÑÎ°ú??/MyMenuLink>
        <MyMenuLink href="/my-models" icon={<IconDropBox    active={pathname.startsWith("/my-models")} />} onClick={() => setMyOpen(false)} active={pathname.startsWith("/my-models")}>??Î™®Îç∏</MyMenuLink>
        <MyMenuLink href="/upload"    icon={<IconDropUpload active={pathname.startsWith("/upload")}    />} onClick={() => setMyOpen(false)} active={pathname.startsWith("/upload")}>?ÖÎ°ú??/MyMenuLink>

        <div style={{ height: 1, background: "#f0ead8", margin: "4px 0" }} />

        {/* ?πÏÖò 2: ?§Ïö¥Î°úÎìú / ?êÎß§?µÍ≥Ñ / Ï∞?/ ?•Î∞îÍµ¨Îãà */}
        <MyMenuLink href="/library"   icon={<IconDropDownload active={pathname.startsWith("/library")}   />} onClick={() => setMyOpen(false)} active={pathname.startsWith("/library")}>???§Ïö¥Î°úÎìú</MyMenuLink>
        <MyMenuLink href="/sales"     icon={<IconDropChart   active={pathname.startsWith("/sales")}     />} onClick={() => setMyOpen(false)} active={pathname.startsWith("/sales")}>?êÎß§?µÍ≥Ñ</MyMenuLink>
        <MyMenuLink href="/favorites" icon={<IconDropHeart   active={pathname.startsWith("/favorites")} />} onClick={() => setMyOpen(false)} active={pathname.startsWith("/favorites")}>Ï∞?/MyMenuLink>
        <MyMenuLink href="/cart"      icon={<IconDropCart    active={pathname.startsWith("/cart")}      />} onClick={() => setMyOpen(false)} active={pathname.startsWith("/cart")}>?•Î∞îÍµ¨Îãà</MyMenuLink>

        <div style={{ height: 1, background: "#f0ead8", margin: "4px 0" }} />

        {/* ?πÏÖò 3: Î¨∏Ïùò / Í≥†Í∞ù?ºÌÑ∞ / ?ÑÏ?Îß?*/}
        <MyMenuLink href="/messages"        icon={<IconDropMail       active={pathname.startsWith("/messages")}        />} onClick={() => setMyOpen(false)} active={pathname.startsWith("/messages")}>Î¨∏Ïùò??/MyMenuLink>
        <MyMenuLink href="/customer-service" icon={<IconDropHeadphones active={pathname.startsWith("/customer-service")} />} onClick={() => setMyOpen(false)} active={pathname.startsWith("/customer-service")}>Í≥†Í∞ù?ºÌÑ∞</MyMenuLink>
        <MyMenuLink href="/help"            icon={<IconDropHelp       active={pathname.startsWith("/help")}            />} onClick={() => setMyOpen(false)} active={pathname.startsWith("/help")}>?ÑÏ?Îß?/MyMenuLink>
  ...
  /* ?Ä?Ä MY Î≤ÑÌäº ?¥Ïö© (?ÑÎ∞î?Ä + MY ?çÏä§?? ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */
  const MyButtonInner = () => (
    <>
      {avatarUrl ? (
        <img
          src={avatarUrl} alt="?ÑÎ°ú??
    ...
    <>
      <header style={{ borderBottom: "1px solid #f0ead8", background: "white", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{
          ...
          {/* ?Ä?Ä Row 1: Î°úÍ≥† + ?§ÎπÑ ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */}
          <div style={{
            ...
            <nav className="header-desktop-nav" style={{ display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <NavItem href="/favorites" label="Ï∞? icon={<IconHeart />} active={pathname === "/favorites"} badge={favoriteCount} />
              <NavItem href="/cart" label="?•Î∞îÍµ¨Îãà" icon={<IconCart />} active={pathname === "/cart"} badge={cartCount} />
              <NavItem href="/library" label="???§Ïö¥Î°úÎìú" icon={<IconDownload />} active={pathname === "/library"} />
              <NavItem href="/messages" label="Î¨∏Ïùò?? icon={<IconMail />} active={pathname === "/messages"} badge={messageCount} />
              <NavItem href="/customer-service" label="Í≥†Í∞ù?ºÌÑ∞" icon={<IconHeadphones />} active={pathname === "/customer-service"} />
              <NavItem href="/help" label="?ÑÏ?Îß? icon={<IconHelp />} active={pathname === "/help"} />
              <NavItem href="/notifications" label="?åÎ¶º" icon={<IconBell />} active={pathname === "/notifications"} badge={notificationCount} />
      ...
      {/* ?Ä?Ä Î™®Î∞î???òÎã® ???§ÎπÑÍ≤åÏù¥???Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */}
...
/* ?Ä?Ä ?∞Ïä§?¨ÌÉë ?§ÎπÑ ?ÑÏù¥???Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */
...
/* ?Ä?Ä ?òÎã® ??Î∞??ÑÏù¥???Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */
...
/* ?Ä?Ä ?úÎ°≠?§Ïö¥ Î©îÎâ¥ ÎßÅÌÅ¨ ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */
...
/* ?Ä?Ä SVG ?ÑÏù¥ÏΩ??Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */
...
/* ?Ä?Ä ?úÎ°≠?§Ïö¥ ?ÑÏö© ?åÌòï ?ÑÏù¥ÏΩ?(15√ó15) ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */
