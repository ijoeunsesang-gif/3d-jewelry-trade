...
const SECTIONS = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "tip",
        body: "구매한 파일은 영구 보관되며 언제든지 다시 다운로드할 수 있습니다.",
      },
    ],
  },
  {
        ...
        items: [
          {
            icon: "🌐",
            label: "공개의뢰",
            desc: "여러 판매자가 볼 수 있는 의뢰입니다. 다양한 판매자가 견적을 제안하며, 가장 마음에 드는 판매자를 선택하면 됩니다.",
          },
          {
            icon: "🎯",
            label: "개인의뢰",
            desc: "특정 판매자를 직접 지정하거나, 판매자 미지정으로 의뢰할 수 있습니다. 원하는 디자이너에게 맞춤 의뢰가 가능합니다.",
          },
        ],
      },
    ],
    ...
    content: [
      {
        ...
        items: [
          ...
          { icon: "⏳", label: "관리자 심사", desc: "운영팀이 신청 내용을 검토합니다" },
          { icon: "✅", label: "승인 후 판매 시작", desc: "승인 완료 후 모델 업로드 및 판매가 가능합니다" },
        ],
      },
      {
        type: "tip",
        body: "심사는 영업일 기준 1~2일 소요됩니다. 승인 완료 시 알림이 발송됩니다.",
      },
    ],
  },
];
