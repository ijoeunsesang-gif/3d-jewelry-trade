...
export interface PartnerRequestApprovedParams {
  businessName: string;
  category: string;
  partnerPageUrl: string;
}

export function buildPartnerApprovedHtml(params: PartnerRequestApprovedParams): string {
  const { businessName, category, partnerPageUrl } = params;
          ...
          <tr>
            <td style="padding:28px 32px 0;">
              <p style="margin:0;font-size:15px;color:#374151;line-height:1.7;">
                안녕하세요.<br>
                신청하신 업체등록이 승인되어 업체정보 페이지에 등록되었습니다.
              </p>
            </td>
          </tr>
